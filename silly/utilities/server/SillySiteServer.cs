...
namespace SillyWidgets.Utilities.Server
{
    ...
    {
        public SillyLambda RequestHandler { get; private set; }
        ...
        public SillySiteServer(SillyLambda requestHandler, int port = 7575, IPAddress ip = null)
        {
        ...
        public async Task Start()
        {
            ...
            while(true)
            {
                ...
                finally
                {
                    ...
                    consoleStr += " (" + timer.Elapsed.TotalMilliseconds + "ms)"; 
